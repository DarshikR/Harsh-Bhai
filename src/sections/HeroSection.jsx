            ...
            <div className="hero bg-[#16377e] min-h-[calc(100dvh-80px)] text-white px-4">
                <div className="w-full flex flex-col">
                    <div className='hero-content px-0 w-full justify-between flex-col md:flex-row-reverse mx-auto'>
                        ...
                        <div>
                            <h1 className="text-2xl text-center md:text-left sm:text-3xl md:text-4xl xl:text-5xl 2xl:text-6xl font-bold font-kaushan text-[#f8d448]">Dira Services</h1>
                            <h1 className="text-4xl text-center md:text-left sm:text-5xl md:text-6xl xl:text-7xl 2xl:text-8xl font-bold">Travel More, <br className='hidden md:block' /> Live More</h1>
